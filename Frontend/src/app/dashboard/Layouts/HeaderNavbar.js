...
// import { FaBell, FaUserCircle, FaGlobe, FaMoon, FaCommentDots, FaSun } from "react-icons/fa";
// import styles from '../../../Styles/HeaderNavbar.module.css';
...
//   const [userName, setUserName] = useState('Ayush Kumar'); // Default user name
//   const [profilePic, setProfilePic] = useState(null); // Profile picture
...
//           <div className={styles.ProfileCardInner}>
//             {profilePic ? (
//               <img src={profilePic} alt="Profile" className={styles.ProfileCardPic} />
//             ) : (
//               <FaUserCircle size={60} />
//             )}
//             <h3>{userName}</h3>
...
// function HeaderNavbar({ toggleMenu, menuVisible }) {
//   return (
